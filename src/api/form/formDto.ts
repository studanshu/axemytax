...
export const formDto = ({ ...formInputs }: FormData): FormData => {
  let transformedData: FormData = JSON.parse(JSON.stringify(formInputs));
...
function transformBusinessType(transformedData: FormData): void {
...
function transformBudget(transformedData: FormData): void {
...
function addEnvironmentToMetaData(transformedData: FormData): void {
