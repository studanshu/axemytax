...
// JSON Data imports
import TDSServiceJsonData from "assets/data/ServicePage/TDSService/index";
import TANCreationJsonData from "assets/data/SubServicePage/TDSService/TAN Creation/index";
import DomesticPropertyTDSJsonData from "assets/data/SubServicePage/TDSService/TDS on Domestic Sale of Property/index";
import RentTDSJsonData from "assets/data/SubServicePage/TDSService/TDS on Rent/index";
import NRIPropertyTDSJsonData from "assets/data/SubServicePage/TDSService/TDS on Purchase of Property from NRI/index";
import TDSReturnFilingJsonData from "assets/data/SubServicePage/TDSService/TDS Return Filing/index";
import TDSCorrectionJsonData from "assets/data/SubServicePage/TDSService/TDS Correction Returns/index";
import FormCertificatesJsonData from "assets/data/SubServicePage/TDSService/Form 16A & 16B/index";
import type { Route } from "types/route.types";

const TDSRoutes: Route = {
  name: "TDS",
  route: "/services/tds",
  component: (
