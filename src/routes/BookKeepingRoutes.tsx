...
// JSON Data imports
import BookKeepingServiceJsonData from "assets/data/ServicePage/BookKeepingService/index";
import BookKeepingServicesUpTo100EntriesSubServiceJsonData from "assets/data/SubServicePage/BookKeepingService/Providing Services Up to 100 Entries/index";
import type { Route } from "types/route.types";

const BookKeepingRoutes: Route = {
  name: "Book Keeping",
  ...
  collapse: [
    {
      ...
      route: "/services/book-keeping/services-up-to-100-entries",
      component: (
